...
The Phase 1 RTA screen study and three visual references are in
[docs/UI_BLUEPRINT.md](docs/UI_BLUEPRINT.md).
The product-wide workspace structure and nine additional tactical, strategic,
